...
export class PanelEstudianteComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.tipo = this.authService.mostrarTipo();
  }
    ...
    this.atencionService.showAll().subscribe(
      ...
      async () => {
        ...
        if (formValues) {
          ...
          canalizacion.personalId = parseInt(localStorage.getItem("id"));
       ...
       /*
        if (gId != undefined && gId != null) {
          var canalizacion: Canalizacion = new Canalizacion();
          canalizacion.personalId = parseInt(this.authService.mostrarIdentificador(localStorage.getItem("id")));
          canalizacion.atencionId = gId;
          canalizacion.estudianteId = this.miEstudiante.id;
